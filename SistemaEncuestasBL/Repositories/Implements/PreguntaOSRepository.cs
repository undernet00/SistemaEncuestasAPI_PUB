...
{
    public class PreguntaOSRepository : GenericRepository<PreguntaOS> , IPreguntaOSRepository
    {
        private readonly SistemaEncuestasContext sistemaEncuestasContext;

        public PreguntaOSRepository(SistemaEncuestasContext encuestaContext) : base(encuestaContext)
        {
            this.sistemaEncuestasContext = encuestaContext;
        }

        public async Task<bool> ActualizarOpciones(PreguntaOS preguntaEnObjeto, PreguntaOS preguntaEnBase)
        {
